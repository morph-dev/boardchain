// Generated by @wagmi/cli@1.3.0 on 8/31/2023 at 4:44:34 PM
import {
  useNetwork,
  useContractRead,
...
/**
 * -
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x6DBbDC25f48d2a5aA2Af4Ee2381360070ddC03da)
 */
    ...
    inputs: [
      { name: 'gameId', internalType: 'uint256', type: 'uint256', indexed: false },
      {
        ...
        components: [
          ...
          { name: 'reason', internalType: 'enum ResultReason', type: 'uint8' },
          { name: 'pointsDifference', internalType: 'uint16', type: 'uint16' },
        ],
        indexed: false,
      },
    ],
...
export const goGameAddress = {
  ...
  11155111: '0x6DBbDC25f48d2a5aA2Af4Ee2381360070ddC03da',
} as const;
...
/**
 * -
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xD7ca2476Ae959e6bcA56Db9e472bD435B4E10Fad)
 */
...
export const goLobbyAddress = {
  ...
  11155111: '0xD7ca2476Ae959e6bcA56Db9e472bD435B4E10Fad',
} as const;
...
/**
 * -
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0xC7e45Bae360248cb8150Df93bCD1f10c86148F82)
 */
...
export const ticTacToeAddress = {
  ...
  11155111: '0xC7e45Bae360248cb8150Df93bCD1f10c86148F82',
} as const;
...
/**
 * -
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x2C37171FdA079C7E79DefEf3B0A2E0C5BF182b4A)
 */
...
export const ticTacToeLobbyAddress = {
  ...
  11155111: '0x2C37171FdA079C7E79DefEf3B0A2E0C5BF182b4A',
} as const;
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link goGameABI}__ and `functionName` set to `"previewScoringState"`.
 *
 * -
 * - [__View Contract on Sepolia Etherscan__](https://sepolia.etherscan.io/address/0x6DBbDC25f48d2a5aA2Af4Ee2381360070ddC03da)
 */
export function useGoGamePreviewScoringState<
  TFunctionName extends 'previewScoringState',
  TSelectData = ReadContractResult<typeof goGameABI, TFunctionName>
>(
  config: Omit<
    UseContractReadConfig<typeof goGameABI, TFunctionName, TSelectData>,
